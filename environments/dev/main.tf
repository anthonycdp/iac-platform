...
# =============================================================================
# This configuration deploys the development environment with cost-optimized
# settings suitable for development and testing.
...
module "security" {
  ...
  enable_budgets        = true
  monthly_budget_amount = 50 # Lower budget for dev
